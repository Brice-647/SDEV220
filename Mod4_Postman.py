...
#https:www.thenerdbook.io/destinations
...
#https:www.thenerdbook.io/destinations2
...
def update_destination(destination_id):
    ...
    if destination:
        ...
        destination.country = data.get("destination", destination.country)
        destination.rating = data.get("destination", destination.rating)
...
def delete_destiantion(destination_id):
    destination = Destination.query.get(destination_id)
    if destination:
